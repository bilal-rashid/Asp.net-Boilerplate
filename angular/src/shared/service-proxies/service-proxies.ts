...
export class OrderServiceProxy {
    ...
    createOrEdit(body: CreateOrEditOrderDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Order/CreateOrEdit";
        url_ = url_.replace(/[?&]$/, "");
    ...
    createOrEditOther(body: CreateOrEditOtherOrderDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Order/CreateOrEditOther";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateOrEditOther(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateOrEditOther(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    getAllOther(customerId: number | undefined, userId: number | undefined, startDate: moment.Moment | undefined, endDate: moment.Moment | undefined, type: OrderType | undefined, sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<GetOrderForViewDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Order/GetAllOther?";
        if (customerId === null)
            throw new Error("The parameter 'customerId' cannot be null.");
        else if (customerId !== undefined)
            url_ += "CustomerId=" + encodeURIComponent("" + customerId) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllOther(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllOther(<any>response_);
                } catch (e) {
                    return <Observable<GetOrderForViewDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetOrderForViewDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processGetAllOther(response: HttpResponseBase): Observable<GetOrderForViewDtoPagedResultDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetOrderForViewDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetOrderForViewDtoPagedResultDto>(<any>null);
    }
    ...
    getForView(id: number | undefined): Observable<GetOrderForViewDto> {
        let url_ = this.baseUrl + "/api/services/app/Order/GetForView?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGetForView(response: HttpResponseBase): Observable<GetOrderForViewDto> {
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetOrderForViewDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    getCustomerBill(customerId: number | undefined): Observable<number> {
        let url_ = this.baseUrl + "/api/services/app/Order/GetCustomerBill?";
        if (customerId === null)
            throw new Error("The parameter 'customerId' cannot be null.");
        else if (customerId !== undefined)
            url_ += "CustomerId=" + encodeURIComponent("" + customerId) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCustomerBill(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCustomerBill(<any>response_);
                } catch (e) {
    ...
    updateCustomerBill(body: UpdateBillDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Order/UpdateCustomerBill";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateCustomerBill(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateCustomerBill(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
...
export class RouteServiceProxy {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<RouteDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<RouteDto>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processGet(response: HttpResponseBase): Observable<RouteDto> {
        ...
        return _observableOf<RouteDto>(<any>null);
    }
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<RouteDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<RouteDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processGetAll(response: HttpResponseBase): Observable<RouteDtoPagedResultDto> {
        ...
        return _observableOf<RouteDtoPagedResultDto>(<any>null);
    }
...
export class CreateOrEditOrderDto implements ICreateOrEditOrderDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.orderItems = _data["orderItems"];
...
export class CreateOrEditOtherOrderDto implements ICreateOrEditOtherOrderDto {
    ...
    constructor(data?: ICreateOrEditOtherOrderDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateOrEditOtherOrderDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateOrEditOtherOrderDto();
        result.init(data);
        return result;
    }
...
export interface ICreateOrEditOtherOrderDto {
    orderItems: string | undefined;
    totalPrice: number;
    userId: number;
    type: OrderType;
...
export class GetOrderForViewDtoPagedResultDto implements IGetOrderForViewDtoPagedResultDto {
    totalCount: number;
    items: GetOrderForViewDto[] | undefined;

    constructor(data?: IGetOrderForViewDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetOrderForViewDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetOrderForViewDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface IGetOrderForViewDtoPagedResultDto {
    totalCount: number;
    items: GetOrderForViewDto[] | undefined;
}

export class UpdateBillDto implements IUpdateBillDto {
    customerId: number;
    amount: number;

    constructor(data?: IUpdateBillDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateBillDto {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateBillDto();
        result.init(data);
        return result;
    }
