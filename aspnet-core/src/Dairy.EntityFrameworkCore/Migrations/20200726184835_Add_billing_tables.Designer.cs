...
namespace Dairy.Migrations
{
    ...
    [Migration("20200726184835_Add_billing_tables")]
    partial class Add_billing_tables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dairy.Dairy.CustomerBills.CustomerBill", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("Dairy_CustomerBill");
                });

            modelBuilder.Entity("Dairy.Dairy.CustomerBillsData.CustomerBillData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("Dairy_CustomerBillData");
                });

            modelBuilder.Entity("Dairy.Dairy.Customers.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Dairy_Customer");
                });

            modelBuilder.Entity("Dairy.Dairy.Orders.Order", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Dairy.Dairy.Products.Product", b =>
                {
                    ...
                    b.ToTable("Dairy_Product");
                });

            modelBuilder.Entity("Dairy.Dairy.RouteData.RouteData", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("CompleteCustomers")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PendingCustomers")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Dairy.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Dairy.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Dairy.Dairy.CustomerBills.CustomerBill", b =>
                {
                    b.HasOne("Dairy.Dairy.Customers.Customer", "Customer")
            ...
            modelBuilder.Entity("Dairy.Dairy.Orders.Order", b =>
                {
                    ...
                    b.HasOne("Dairy.Authorization.Users.User", "User")
                        .WithMany("Orders")
                        .HasForeignKey("UserId");
                });
